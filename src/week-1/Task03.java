...
//        也可以把BigInteger转换成long型：
        ...
        System.out.println(i.multiply(i)); // 15241578750190521000000
...
//        BigInteger to float
        ...
        long  l = n.longValue();
        System.out.println(f);//Infinity无穷
        System.out.println(d);//Infinity无穷
        System.out.println(l);//5920146666018336447
